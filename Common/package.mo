...
package Common "Библиотека общих данных для бибилиотеки Seneca (Версия 0.0.1)/Library of Sulfur common data for library Seneca (version 0.0.1)"
  import Modelica.Icons.Package;

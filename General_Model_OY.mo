...
model General_Model_OY
  import Modelica.Fluid.Sources.*;
  /*
                                                                                                                                                                        Это комплексная модель установки, которая использует все наработки этой бибилиотеки
                                                                                                                                                                        */
  Modelica.Fluid.Sources.MassFlowSource_T acidGas "Источник кислого газа" annotation(Placement(visible = true, transformation(origin = {-537, 161}, extent = {{-49, -49}, {49, 49}}, rotation = 0)));
  Modelica.Fluid.Sources.FixedBoundary airTube(nPorts = 1) "Труба" annotation(Placement(visible = true, transformation(origin = {633, 169}, extent = {{-57, -67}, {57, 67}}, rotation = 180)));
...
equation
  ...
  annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-600, -400}, {700, 400}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})));
